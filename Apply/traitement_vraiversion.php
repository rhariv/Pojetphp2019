			...
			<form  method="POST" action="recherche.php" class="formulaire" id="formulaire">
				<div class="partie_gauche">
					<table class="tableau">
						...
						<tr>
						<td class="partie_droite_gauche" id="titre">
							<input type="text" name="materiel" value="Veuillez saisir les mots" id ="moteur" onkeyup="controle_saisie()" onclick="init_saisie('1')" onmouseout="init_saisie('2')" /><td>
						<td id="prop" class="prop" style="float:right;"> texte  </td>	
						</tr>
